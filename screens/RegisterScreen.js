...
//     if (email === "" || password === "" || phone === "" || confirmPassword == "" || (password !== confirmPassword)) {
//       Alert.alert(
//         "Champ(s) invalide(s)",
...
//       <ScrollView contentContainerStyle={{flexGrow:1, padding: windowWidth*0.05}}> {/* add ScrollView and padding based on windowWidth */}
...
//           }}
//         > */}
//         <View style={{ marginTop: windowWidth*0.05 }}> {/* use windowWidth for marginTop */}
...
//         <View style={{ flexDirection: "row", alignItems: "center", marginTop: windowWidth*0.05 }}> {/* use windowWidth for marginTop */}
